/*
 * SPDX-FileCopyrightText: 2015 The CyanogenMod Open Source Project
...
#define is_spkr_out_snd_dev(x) \
    ...
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_LINE) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_HDMI) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_DISPLAY_PORT) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_ANC_HEADSET) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_ANC_FB_HEADSET) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_USB_HEADSET) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_BT_A2DP) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_BT_SCO) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_BT_SCO_WB) || \
    ((x) == SND_DEVICE_OUT_SPEAKER_AND_BT_SCO_SWB) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_2) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_STEREO) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_HFP) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_AND_VOICE_HEADPHONES) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_AND_VOICE_ANC_HEADSET) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_AND_VOICE_ANC_FB_HEADSET) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_STEREO_AND_VOICE_HEADPHONES) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_STEREO_AND_VOICE_ANC_HEADSET) || \
    ((x) == SND_DEVICE_OUT_VOICE_SPEAKER_STEREO_AND_VOICE_ANC_FB_HEADSET) || \
    ((x) == SND_DEVICE_OUT_VOIP_SPEAKER))
/* clang-format on */
